...
export function analyseLinks(roomName: string) {
    ...
    const linksInRoom = Object.keys(Memory.rooms[roomName].monitoring.structures.links).map(linkId => Game.getObjectById(linkId as Id<StructureLink>)) as StructureLink[]
